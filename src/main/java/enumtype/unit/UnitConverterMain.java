...
public class UnitConverterMain {
    public static void main(String[] args) {
        ...
        System.out.println(unitConverter.convert(new BigDecimal(1000), LengthUnit.YARD, LengthUnit.CENTIMETER));
        ...
        System.out.println("Length units: " + Arrays.toString(LengthUnit.values()));
        System.out.println("SI length units: " + unitConverter.siUnits());
    }
}
