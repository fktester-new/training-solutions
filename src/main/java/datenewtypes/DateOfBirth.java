...
public class DateOfBirth {
    ...
    public int countDaysBetween(DateOfBirth other){
        if (other == null) {
            throw new NullPointerException("Parameter must nit be null!");
        }
        return (int) ChronoUnit.DAYS.between(dateOfBirth, other.dateOfBirth);
    }
    public boolean isWeekDay(){
        return !dateOfBirth.getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.ENGLISH).equals("Saturday") && !dateOfBirth.getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.ENGLISH).equals("Sunday");
    }
