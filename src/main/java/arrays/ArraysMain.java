...
public class ArraysMain {
    ...
    public boolean sameTempValuesNew(double[] day, double[] anotherDay) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(arraysMain.sameTempValues(new double[] {1, 2, 3}, new double[] {2, 3, 4}));

        System.out.println(arraysMain.sameTempValuesNew(new double[] {1, 2}, new double[] {1, 2, 3}));
        System.out.println(arraysMain.sameTempValuesNew(new double[] {1, 3}, new double[] {1, 2, 3}));
