...
public class BankTransaction {
    ...
    private static long trxCount = 0;
    ...
    public static long getCurrentMinValue() {
        return trxCount == 0 ? 0 : currentMinValue;
    }

    public static long getCurrentMaxValue() {
        return trxCount == 0 ? 0 : currentMaxValue;
    }
    ...
    public static BigDecimal averageOfTransaction(){
        return trxCount == 0 ? new BigDecimal("0") : sumOfTrxs.divide(new BigDecimal(Long.toString(trxCount)), 0, RoundingMode.HALF_UP);
    }
