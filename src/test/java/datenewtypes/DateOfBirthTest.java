...
public class DateOfBirthTest {
    ...
    @Test
    public void testIsWeeksDay(){
        // Given
        DateOfBirth dob = new DateOfBirth(2017, 2, 1);
        DateOfBirth dob1 = new DateOfBirth(2018, 6, 3);
        //Then
        assertTrue(dob.isWeekDay());
        assertFalse(dob1.isWeekDay());
    }

    @Test
    public void testIsALeapYear(){
        // Given
        DateOfBirth dob = new DateOfBirth(2016, 2, 1);
        DateOfBirth dob1 = new DateOfBirth(2018, 6, 3);
        //Then
        assertTrue(dob.wasItALeapYear());
        assertFalse(dob1.wasItALeapYear());
    }
}